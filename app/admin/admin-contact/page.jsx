...
export default function AdminContactEnquiries() {
  ...
  const handleExport = async () => {
    try {
      ...
      downloadCSV(csv, `contact_enquiries_${format(new Date(), 'yyyy-MM-dd_HH-mm')}.csv`);
    } catch (error) {
  ...
  const convertToCSV = (data) => {
    const headers = ["Date", "Name", "Email", "Phone", "Address", "Message", "Status", "Notes", "IP Address"];
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Manage and track all customer messages
              </p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-gray-900 outline-none"
                  />
                </div>
                <button
                  type="submit"
                  className="px-6 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 whitespace-nowrap"
                >
                  Search
                </button>
              </div>
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              <select
                ...
                className="flex-1 sm:flex-none px-4 py-2 border rounded-lg focus:ring-2 focus:ring-gray-900 outline-none bg-white"
              >
          ...
          <div className="relative bg-white rounded-xl shadow-2xl max-w-2xl w-full mx-4 p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="font-medium bg-gray-50 p-3 rounded-lg mt-1">{selectedEnquiry.address}</p>
              </div>
              
              <div>
                <label className="text-sm text-gray-500">Message</label>
                <p className="font-medium bg-gray-50 p-3 rounded-lg mt-1 whitespace-pre-wrap">{selectedEnquiry.message}</p>
              </div>
            ...
            <div className="mt-6 flex justify-end gap-2">
              <select
                ...
                className="px-4 py-2 border rounded-lg focus:ring-2 focus:ring-gray-900 outline-none"
              >
                <option value="pending">Pending</option>
                <option value="contacted">Contacted</option>
                <option value="resolved">Resolved</option>
